        ...
        <div className="wrap">
          <div className="stu-hero">
            <div className="stu-hero-text">
              <div className="eyebrow no-slash stu-accent-fg">— chi siamo · studio</div>
              <h1 className="mega" data-kinetic="lines" style={{ marginTop: 20 }}>
                Testa,<br />cuore<br />e <span className="stu-accent-fg">metodo.</span>
              </h1>
              <p className="lead text-pretty" data-reveal="" data-reveal-d="2" style={{ marginTop: 26, maxWidth: '46ch' }}>
                Strategist, designer, video-maker e copy che si prendono sul serio solo quando serve.
                Siamo nel food perché ci piace — e lavoriamo con qualsiasi brand abbia qualcosa di vero da dire.
              </p>
