        ...
        <div className="stu-vals-grid">
          <div className="stu-val" data-reveal="">
            ...
            <div className="stu-val-main">
              <h3 className="h3" data-cid="TE3">Gusto prima di tutto</h3>
              <p className="body text-pretty" data-cid="TE4" style={{ marginTop: 14, maxWidth: '44ch', color: 'var(--ink-2)' }}>
          ...
          <div className="stu-val" data-reveal="" data-reveal-d="1">
            ...
            <div className="stu-val-main">
              <h3 className="h3" data-cid="TE5">Dati senza fuffa</h3>
              <p className="body text-pretty" data-cid="TE6" style={{ marginTop: 14, maxWidth: '44ch', color: 'var(--ink-2)' }}>
          ...
          <div className="stu-val" data-reveal="" data-reveal-d="2">
            ...
            <div className="stu-val-main">
              <h3 className="h3" data-cid="TE7">Mani in pasta</h3>
              <p className="body text-pretty" data-cid="TE8" style={{ marginTop: 14, maxWidth: '44ch', color: 'var(--ink-2)' }}>
