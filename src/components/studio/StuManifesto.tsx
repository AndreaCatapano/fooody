export default function StuManifesto() {
  return (
    <section className="section ink-region" data-bg="ink" id="manifesto">
      <div className="wrap">
        <div className="eyebrow no-slash stu-accent-fg" data-reveal="" data-cid="TC1e">— manifesto</div>
        <h2 className="h1 text-balance" data-kinetic="words" data-cid="TC1"
        ...
        <div className="stu-manifesto-body" data-reveal="" data-reveal-d="2">
          <p className="lead text-pretty" data-cid="TC2" style={{ maxWidth: '54ch', color: 'rgba(247,244,238,.82)' }}>
          ...
          <p className="lead text-pretty" data-cid="TC3" style={{ maxWidth: '54ch', color: 'rgba(247,244,238,.82)', marginTop: 22 }}>
