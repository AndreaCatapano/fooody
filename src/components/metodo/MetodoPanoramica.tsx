    ...
    <section className="section" data-bg="paper" id="panoramica" data-sig="">
      <div className="wrap">
        ...
        <div className="pillars-map">
          <a className="pmap pmap-1" href="#pilastri" data-reveal="" data-cid="MC4">
          ...
          <a className="pmap pmap-2" href="#pilastri" data-reveal="" data-reveal-d="1" data-cid="MC5">
          ...
          <a className="pmap pmap-3" href="#pilastri" data-reveal="" data-reveal-d="2" data-cid="MC6">
          ...
          <a className="pmap pmap-4" href="#pilastri" data-reveal="" data-reveal-d="3" data-cid="MC7">
          ...
          <a className="pmap pmap-5" href="#pilastri" data-reveal="" data-reveal-d="4" data-cid="MC8">
