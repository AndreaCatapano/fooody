    ...
    >
      <div className="wrap">
        <div className="lav-hero">
          <div>
            <div className="eyebrow no-slash" data-cid="CA1" style={{ color: 'var(--tomato)' }}>— prima call gratuita</div>
            <h1 className="mega" data-kinetic="lines" data-cid="CA2" style={{ marginTop: 18 }}>
              Parliamo<br /><span style={{ color: 'var(--tomato)' }}>di cibo.</span>
            </h1>
          </div>
          <div className="lav-hero-desc" data-reveal="" data-reveal-d="1">
            <p className="lead text-pretty" data-cid="CA3" style={{ color: 'rgba(247,244,238,.78)', maxWidth: '44ch' }}>
