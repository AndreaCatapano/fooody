      ...
      <div className="wrap">
        <div className="soc-feed-head">
          <div className="soc-feed-lede">
            <div className="eyebrow no-slash" data-cid="SB1">
              <span className="soc-live-dot" aria-hidden="true" />
              <span className="soc-accent-fg">il feed, vivo</span>
            </div>
            <h2 className="hero-type" data-kinetic="lines" data-cid="SB2" style={{ marginTop: 16, color: 'var(--paper)' }}>
              Non un portfolio.<br />Un feed che<br />respira.
            </h2>
            <p className="small" data-reveal="" data-cid="SB3" style={{ color: 'rgba(247,244,238,.6)', maxWidth: '40ch', marginTop: 20 }}>
