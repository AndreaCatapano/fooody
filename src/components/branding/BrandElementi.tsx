export default function BrandElementi() {
  return (
    <section className="section" data-bg="paper" id="elementi">
      <div className="wrap">
        <div className="eyebrow brand-eyebrow" data-reveal="" data-cid="BD1">gli elementi che consegniamo</div>
        <h2 className="h1 text-balance" data-kinetic="words" data-cid="BD2" style={{ marginTop: 16, maxWidth: '18ch' }}>
        ...
        <div className="sys-grid" data-reveal="" data-reveal-d="2">
          <div className="sys-tile sys-color">
            ...
            <p className="small" data-cid="BD3">Palette primaria, secondaria e neutri — con i codici per ogni supporto.</p>
          </div>
          <div className="sys-tile sys-typeface">
            <span className="mono-xs">tipografia</span>
            <span className="sys-type-big">Aa Bb</span>
            <p className="small" data-cid="BD4">Famiglia display e da testo, scala tipografica, regole d&apos;uso.</p>
          </div>
          <div className="sys-tile sys-logo">
            ...
            <p className="small" data-cid="BD5">Logo principale, versioni, area di rispetto e dimensioni minime.</p>
          </div>
        </div>
      </div>
    </section>
