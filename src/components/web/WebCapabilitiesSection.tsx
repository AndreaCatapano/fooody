export default function WebCapabilitiesSection() {
  return (
    <section className="section" data-bg="paper" id="stack">
      <div className="wrap">
        <div className="eyebrow web-eyebrow" data-reveal="" data-cid="WD1">cosa sappiamo costruire</div>
        <h2 className="h1 text-balance" data-kinetic="words" data-cid="WD2" style={{ marginTop: 16, maxWidth: '20ch' }}>
          Dal sito vetrina all&apos;e-commerce con mille referenze.
        </h2>
        <div className="web-cap-grid" data-reveal="" data-reveal-d="2">
          <div className="web-cap-card" data-cid="WD3">
          ...
          <div className="web-cap-card" data-cid="WD4">
          ...
          <div className="web-cap-card" data-cid="WD5">
          ...
          <div className="web-cap-card" data-cid="WD6">
